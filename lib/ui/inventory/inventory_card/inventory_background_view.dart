...
class InventoryBackgroundView extends StatelessWidget {
  const InventoryBackgroundView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final items = itemProvider.itemsByCategory('background');
    ...
    if (items.isEmpty) {
      return const Center(child: Text('보유 중인 배경이 없습니다.', style: TextStyle(color: Colors.white70)));
    }
        ...
        return GestureDetector(
          ...
          child: Container(
            decoration: BoxDecoration(
              border: Border.all(color: owned ? Colors.orangeAccent : Colors.grey),
